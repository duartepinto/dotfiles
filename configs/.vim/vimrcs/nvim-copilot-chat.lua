...
map("n", "<leader>zd", function()
  git_diff_with_copilot("Explain this git diff. If it is a bigger diff, talk about the different parts of the codebase it touches and how the changes affect how things interact. If possible, be visual.")
